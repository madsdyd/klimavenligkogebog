...
\begin{document}
	...
	\newenvironment{rurecipe}[8]{
		...
		[%
			portion={\portion{#3}},
			preparationtime={#6},
			calory={#5 : #4 (Kg ækvivalenter per person/total)}
		]
		{\textcolor{magenta}{#1}}
...
\thispagestyle{empty}
\begin{center}
{\textbf{\textcolor{magenta}{\huge Radikal Ungdoms Klimavenlige Kogebog}}}
\end{center}
\newpage
...
List over opskrifter, sorteret efter $CO_2$ belastning.

\begin{longtable}{|l|l|l|}
	\hline
	\textbf{\coo} & \textbf{Rating} & \textbf{Navn}\\ \hline
	\rucoorecipes		
\end{longtable}
